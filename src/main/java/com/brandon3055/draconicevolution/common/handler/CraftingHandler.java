...
public class CraftingHandler {
    public static void init() {
        ...
        if (true) {//enable Schrecktech
            ...
            addOre(ModItems.wyvernEnergyCore, "IBI", "BCB", "IBI", 'I', "ingotDraconium", 'B', Ic2Items.lapotronCrystal, 'C', ModItems.draconicCore);
            addOre(ModItems.draconicEnergyCore, "IBI", "BCB", "IBI", 'I', "ingotDraconiumAwakened", 'B', ItemList.Energy_LapotronicOrb.get(1, Ic2Items.lapotronCrystal), 'C', ModItems.wyvernCore);
            ...
            //armor
            addOre(ModItems.wyvernHelm, "PWP", "IAI", "PEP", 'W', ModItems.wyvernCore, 'I', ModItems.draconiumIngot, 'A', Ic2Items.quantumHelmet, 'E', ModItems.wyvernEnergyCore, 'P', "plateNeutronium");
            ...
            addOre(ModItems.draconicAxe, " C ", "ITI", " E ", 'C', ModItems.awakenedCore, 'I', "ingotDraconiumAwakened", 'T', Items.diamond_axe, 'E', ModItems.draconicEnergyCore);
            addOre(ModItems.draconicHoe, " C ", "ITI", " E ", 'C', ModItems.awakenedCore, 'I', "ingotDraconiumAwakened", 'T', Items.diamond_hoe, 'E', ModItems.draconicEnergyCore);
            ...
            //armor
            addEnergy(ModItems.draconicHelm, "PWP", "IAI", "PEP", 'W', ModItems.awakenedCore, 'I', "ingotDraconiumAwakened", 'A', ModItems.wyvernHelm, 'E', ModItems.draconicEnergyCore, 'P', "plateHypogen");
            addEnergy(ModItems.draconicChest, "PWP", "IAI", "PEP", 'W', ModItems.awakenedCore, 'I', "ingotDraconiumAwakened", 'A', ModItems.wyvernChest, 'E', ModItems.draconicEnergyCore, 'P', "plateHypogen");
            addEnergy(ModItems.draconicLeggs, "PWP", "IAI", "PEP", 'W', ModItems.awakenedCore, 'I', "ingotDraconiumAwakened", 'A', ModItems.wyvernLeggs, 'E', ModItems.draconicEnergyCore, 'P', "plateHypogen");
            addEnergy(ModItems.draconicBoots, "PWP", "IAI", "PEP", 'W', ModItems.awakenedCore, 'I', "ingotDraconiumAwakened", 'A', ModItems.wyvernBoots, 'E', ModItems.draconicEnergyCore, 'P', "plateHypogen");
            ...
            addOre(ModBlocks.weatherController, "RIR", "TPT", "IEI", 'R', Items.blaze_rod, 'T', Blocks.tnt, 'P', ModItems.draconicCore, 'I', "ingotDraconium", 'E', Blocks.enchanting_table);
            addOre(ModBlocks.playerDetectorAdvanced, "ISI", "EDE", "ICI", 'I', "ingotDraconium", 'E', Items.ender_eye, 'S', new ItemStack(Items.skull, 1, 1), 'C', Items.compass, 'D', ModBlocks.playerDetector);
            addOre(ModBlocks.energyInfuser, "IPI", "CEC", "ICI", 'I', "ingotDraconium", 'P', ModBlocks.particleGenerator, 'C', ModItems.draconicCore, 'E', Blocks.enchanting_table);
            addOre(ModBlocks.draconiumChest, "IFI", "SCS", "IWI", 'I', "ingotDraconium", 'C', ModItems.draconicCore, 'S', getChest(), 'W', Blocks.crafting_table, 'F', Blocks.furnace);
            addOre(getStack(ModBlocks.energyPylon, 2, 0), "IEI", "MCM", "IDI", 'I', "ingotDraconium", 'E', Items.ender_eye, 'C', ModItems.draconicCore, 'D', "gemDiamond", 'M', "gemEmerald");
            addOre(getStack(ModBlocks.grinder, 1, 3), "IXI", "DCD", "IFI", 'I', "ingotIron", 'X', "ingotDraconium", 'D', Items.diamond_sword, 'C', ModItems.draconicCore, 'F', Blocks.furnace);
            ...
            addOre(ModItems.wrench, " ID", " RI", "C  ", 'I', "ingotDraconium", 'D', "gemDiamond", 'R', Items.blaze_rod, 'C', ModItems.draconicCore);
            ...
            addOre(ModBlocks.sunDial, "IAI", "CDC", "IEI", 'I', "ingotDraconium", 'A', ModItems.awakenedCore, 'C', ModItems.draconicCore, 'E', Blocks.enchanting_table, 'D', Blocks.dragon_egg);
            ...
            addEnergy(ModItems.draconicLeggs, "IWI", "IAI", "IEI", 'W', ModItems.awakenedCore, 'I', "ingotDraconiumAwakened", 'A', ModItems.wyvernLeggs, 'E', ModItems.draconicEnergyCore);
            addEnergy(ModItems.draconicBoots, "IWI", "IAI", "IEI", 'W', ModItems.awakenedCore, 'I', "ingotDraconiumAwakened", 'A', ModItems.wyvernBoots, 'E', ModItems.draconicEnergyCore);
